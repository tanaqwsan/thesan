...
function GonWebhook(Shinuqi)
    ...
    url = "https://emoji.discadia.com/emojis/68d9cb22-089d-4b9c-9fe7-a2c26d4f23df.gif"
    }
    $color = Get-Random -Minimum 0 -Maximum 16777215
    $title = 'CLarke : <:online:1156775520411861082>'
    $description = "**]]..Shinuqi..[[**"
  
    $footer = [PSCustomObject]@{
        icon_url = "https://emoji.discadia.com/emojis/68d9cb22-089d-4b9c-9fe7-a2c26d4f23df.gif"
...
function Dropf(list)
    ...
    if inventory:getItemCount(BlockID+1) >= 160 then
        ...
        while (inventory:getItemCount(BlockID+1) > 0) do
            ...
            sleep(500)
            getBot():say("Rotasi by Ananda Saber")
            bot:moveLeft()
        end
